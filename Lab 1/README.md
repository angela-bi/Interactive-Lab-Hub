...
- If you want to incorporate sound, make it so that when color is made, play a sound
- Does the lighting of a room effect the ability to play the game?
- Audio cues for if players get closer to the color
