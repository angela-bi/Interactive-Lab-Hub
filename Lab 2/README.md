...
Kyle Li (kl2296) and Jesse Iriah (ji227) helped give me feedback. My roommate helped me test my prototype!
...
Based on the user feedback I got from Kyle and Jesse, I added functionality to my code that included the current time, and a user's ability to press the buttons on the screen to set alarms (button A to toggle the hour and button B to toggle the minutes) and the ability to press both buttons at the same time to snooze an alarm for 5 minutes. I decided that snoozing an alarm for 5 minutes would be better than either making the videos louder or softer. Updated code here and in `updated_alarm.py`:
